---
title: 'Failed tea experiment that I did not want to put on my Substack'
chineseName: '失败的茶实验'
...
| **101 7542** | Just a name for a famous factory sheng [pu'er](https://babelcarp.org/babelcarp/babelcarp.cgi?phrase=pu%27er&define=1) tea. Factory means it was produced by one of the famous factories. Pu'er is a type of aged tea from Yunnan. 101 means this is the first batch produced in 2011. <br /><br /> 7542 is the [tea recipe number](https://teadb.org/reading-drinking-numbers/), 75 = recipe developed in 1975, 4 = uses 4th grade leaves, 2 = produced by factory number 2 (Dayi). Pains me to TLDR this much but this is the basic idea.|
...
![Warming up for some tea](/images/blog/failed-tea-experiment/tasting-empty.jpg)


## 7542

![Brewing~](/images/blog/failed-tea-experiment/tasting-pour.jpg)
...
![Tasting the 7542! Color is on point.](/images/blog/failed-tea-experiment/tasting-7542.jpg)
...
![Tasting the Liudui~ Much lighter!](/images/blog/failed-tea-experiment/tasting-liudui.jpg)
...
![Tasting the Liudui~ Much lighter!](/images/blog/failed-tea-experiment/pouring-from-gaiwan.jpg)
